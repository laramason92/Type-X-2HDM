...
V_7 = Vertex(name = 'V_7',
             particles = [ P.P__tilde__A0, P.P__tilde__A0, P.G0, P.G0 ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_121})

V_8 = Vertex(name = 'V_8',
             particles = [ P.P__tilde__A0, P.P__tilde__A0, P.G__minus__, P.G__plus__ ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_118})

V_9 = Vertex(name = 'V_9',
             particles = [ P.G0, P.G0, P.P__tilde__H__minus__, P.P__tilde__H__plus__ ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_118})

V_10 = Vertex(name = 'V_10',
              particles = [ P.G__minus__, P.G__plus__, P.P__tilde__H__minus__, P.P__tilde__H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_119})

V_11 = Vertex(name = 'V_11',
              particles = [ P.P__tilde__A0, P.G0, P.G__plus__, P.P__tilde__H__minus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_120})

V_12 = Vertex(name = 'V_12',
              particles = [ P.P__tilde__A0, P.G0, P.G__minus__, P.P__tilde__H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_120})

V_13 = Vertex(name = 'V_13',
              particles = [ P.G__plus__, P.G__plus__, P.P__tilde__H__minus__, P.P__tilde__H__minus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_122})

V_14 = Vertex(name = 'V_14',
              particles = [ P.G__minus__, P.G__minus__, P.P__tilde__H__plus__, P.P__tilde__H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_122})

V_15 = Vertex(name = 'V_15',
              particles = [ P.P__tilde__A0, P.G0, P.G0, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_99})

V_16 = Vertex(name = 'V_16',
              particles = [ P.P__tilde__A0, P.G0, P.G__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_95})

V_17 = Vertex(name = 'V_17',
              particles = [ P.G0, P.G0, P.G__plus__, P.P__tilde__H__minus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_95})

V_18 = Vertex(name = 'V_18',
              particles = [ P.G__minus__, P.G__plus__, P.G__plus__, P.P__tilde__H__minus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_97})

V_19 = Vertex(name = 'V_19',
              particles = [ P.G0, P.G0, P.G__minus__, P.P__tilde__H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_95})

V_20 = Vertex(name = 'V_20',
              particles = [ P.G__minus__, P.G__minus__, P.G__plus__, P.P__tilde__H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_97})

V_21 = Vertex(name = 'V_21',
              particles = [ P.P__tilde__A0, P.P__tilde__A0, P.P__tilde__A0, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_98})

V_22 = Vertex(name = 'V_22',
              particles = [ P.P__tilde__A0, P.P__tilde__A0, P.G__plus__, P.P__tilde__H__minus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_94})

V_23 = Vertex(name = 'V_23',
              particles = [ P.P__tilde__A0, P.P__tilde__A0, P.G__minus__, P.P__tilde__H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_94})

V_24 = Vertex(name = 'V_24',
              particles = [ P.P__tilde__A0, P.G0, P.P__tilde__H__minus__, P.P__tilde__H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_94})

V_25 = Vertex(name = 'V_25',
              particles = [ P.G__plus__, P.P__tilde__H__minus__, P.P__tilde__H__minus__, P.P__tilde__H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_96})

V_26 = Vertex(name = 'V_26',
              particles = [ P.G__minus__, P.P__tilde__H__minus__, P.P__tilde__H__plus__, P.P__tilde__H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_96})

V_27 = Vertex(name = 'V_27',
              particles = [ P.P__tilde__A0, P.G__plus__, P.P__tilde__H__minus__ ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
              couplings = {(0,0):C.GC_189})

V_28 = Vertex(name = 'V_28',
              particles = [ P.P__tilde__A0, P.G__minus__, P.P__tilde__H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
...
V_38 = Vertex(name = 'V_38',
              particles = [ P.ghWm, P.ghWm__tilde__, P.P__tilde__A0 ],
              color = [ '1' ],
              lorentz = [ L.UUS1 ],
...
V_46 = Vertex(name = 'V_46',
              particles = [ P.ghWp, P.ghWp__tilde__, P.P__tilde__A0 ],
              color = [ '1' ],
              lorentz = [ L.UUS1 ],
...
V_121 = Vertex(name = 'V_121',
               particles = [ P.P__tilde__A0, P.G__plus__, P.h1, P.P__tilde__H__minus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_103})

V_122 = Vertex(name = 'V_122',
               particles = [ P.P__tilde__A0, P.G__minus__, P.h1, P.P__tilde__H__plus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_102})

V_123 = Vertex(name = 'V_123',
               particles = [ P.G0, P.G__plus__, P.h1, P.P__tilde__H__minus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_101})

V_124 = Vertex(name = 'V_124',
               particles = [ P.G0, P.G__minus__, P.h1, P.P__tilde__H__plus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
...
V_129 = Vertex(name = 'V_129',
               particles = [ P.P__tilde__A0, P.G0, P.h1 ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_215})

V_130 = Vertex(name = 'V_130',
               particles = [ P.G__plus__, P.h1, P.P__tilde__H__minus__ ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_214})

V_131 = Vertex(name = 'V_131',
               particles = [ P.G__minus__, P.h1, P.P__tilde__H__plus__ ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_214})
...
V_136 = Vertex(name = 'V_136',
               particles = [ P.P__tilde__A0, P.G0, P.h1, P.h1 ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_59})

V_137 = Vertex(name = 'V_137',
               particles = [ P.G__plus__, P.h1, P.h1, P.P__tilde__H__minus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_58})

V_138 = Vertex(name = 'V_138',
               particles = [ P.G__minus__, P.h1, P.h1, P.P__tilde__H__plus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_58})
...
V_141 = Vertex(name = 'V_141',
               particles = [ P.P__tilde__A0, P.G__plus__, P.h2, P.P__tilde__H__minus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_107})

V_142 = Vertex(name = 'V_142',
               particles = [ P.P__tilde__A0, P.G__minus__, P.h2, P.P__tilde__H__plus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_106})

V_143 = Vertex(name = 'V_143',
               particles = [ P.G0, P.G__plus__, P.h2, P.P__tilde__H__minus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_105})

V_144 = Vertex(name = 'V_144',
               particles = [ P.G0, P.G__minus__, P.h2, P.P__tilde__H__plus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
...
V_149 = Vertex(name = 'V_149',
               particles = [ P.P__tilde__A0, P.G0, P.h2 ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_217})

V_150 = Vertex(name = 'V_150',
               particles = [ P.G__plus__, P.h2, P.P__tilde__H__minus__ ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_216})

V_151 = Vertex(name = 'V_151',
               particles = [ P.G__minus__, P.h2, P.P__tilde__H__plus__ ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_216})
...
V_156 = Vertex(name = 'V_156',
               particles = [ P.P__tilde__A0, P.G0, P.h1, P.h2 ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_65})

V_157 = Vertex(name = 'V_157',
               particles = [ P.G__plus__, P.h1, P.h2, P.P__tilde__H__minus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_64})

V_158 = Vertex(name = 'V_158',
               particles = [ P.G__minus__, P.h1, P.h2, P.P__tilde__H__plus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_64})
...
V_165 = Vertex(name = 'V_165',
               particles = [ P.P__tilde__A0, P.G0, P.h2, P.h2 ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_67})

V_166 = Vertex(name = 'V_166',
               particles = [ P.G__plus__, P.h2, P.h2, P.P__tilde__H__minus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_66})

V_167 = Vertex(name = 'V_167',
               particles = [ P.G__minus__, P.h2, P.h2, P.P__tilde__H__plus__ ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_66})
...
V_173 = Vertex(name = 'V_173',
               particles = [ P.P__tilde__A0, P.G__plus__, P.P__tilde__H__minus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_111})

V_174 = Vertex(name = 'V_174',
               particles = [ P.P__tilde__A0, P.G__minus__, P.P__tilde__H__plus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_110})

V_175 = Vertex(name = 'V_175',
               particles = [ P.G0, P.G__plus__, P.P__tilde__H__minus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_109})

V_176 = Vertex(name = 'V_176',
               particles = [ P.G0, P.G__minus__, P.P__tilde__H__plus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
...
V_181 = Vertex(name = 'V_181',
               particles = [ P.P__tilde__A0, P.G0, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_219})

V_182 = Vertex(name = 'V_182',
               particles = [ P.G__plus__, P.P__tilde__H__minus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_218})

V_183 = Vertex(name = 'V_183',
               particles = [ P.G__minus__, P.P__tilde__H__plus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_218})

V_184 = Vertex(name = 'V_184',
               particles = [ P.G0, P.G0, P.h1, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_85})

V_185 = Vertex(name = 'V_185',
               particles = [ P.G__minus__, P.G__plus__, P.h1, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
...
V_188 = Vertex(name = 'V_188',
               particles = [ P.P__tilde__A0, P.G0, P.h1, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_77})

V_189 = Vertex(name = 'V_189',
               particles = [ P.G__plus__, P.h1, P.P__tilde__H__minus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_76})

V_190 = Vertex(name = 'V_190',
               particles = [ P.G__minus__, P.h1, P.P__tilde__H__plus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_76})
...
V_193 = Vertex(name = 'V_193',
               particles = [ P.G0, P.G0, P.h2, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_89})

V_194 = Vertex(name = 'V_194',
               particles = [ P.G__minus__, P.G__plus__, P.h2, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
...
V_197 = Vertex(name = 'V_197',
               particles = [ P.P__tilde__A0, P.G0, P.h2, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_79})

V_198 = Vertex(name = 'V_198',
               particles = [ P.G__plus__, P.h2, P.P__tilde__H__minus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_78})

V_199 = Vertex(name = 'V_199',
               particles = [ P.G__minus__, P.h2, P.P__tilde__H__plus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_78})
...
V_209 = Vertex(name = 'V_209',
               particles = [ P.P__tilde__A0, P.G0, P.S, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_81})

V_210 = Vertex(name = 'V_210',
               particles = [ P.G__plus__, P.P__tilde__H__minus__, P.S, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_80})

V_211 = Vertex(name = 'V_211',
               particles = [ P.G__minus__, P.P__tilde__H__plus__, P.S, P.S ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_80})
...
V_360 = Vertex(name = 'V_360',
               ...
               couplings = {(0,0):C.GC_154,(0,1):C.GC_159})
