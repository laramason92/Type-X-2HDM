...
V_7 = Vertex(name = 'V_7',
             particles = [ P.a, P.h0, P.A0 ],
             color = [ '1' ],
             lorentz = [ L.VSS1 ],
             couplings = {(0,0):C.GC_81})

V_8 = Vertex(name = 'V_8',
             particles = [ P.a, P.H, P.A0 ],
             color = [ '1' ],
             lorentz = [ L.VSS1 ],
...
V_39 = Vertex(name = 'V_39',
              particles = [ P.ta__plus__, P.ta__minus__, P.h0 ],
              color = [ '1' ],
              lorentz = [ L.FFS4 ],
...
V_61 = Vertex(name = 'V_61',
              particles = [ P.a, P.W__minus__, P.h0, P.h__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_64 = Vertex(name = 'V_64',
              particles = [ P.W__minus__, P.h0, P.h__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
...
V_68 = Vertex(name = 'V_68',
              particles = [ P.a, P.W__plus__, P.h0, P.h__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_63})
...
V_71 = Vertex(name = 'V_71',
              particles = [ P.W__plus__, P.h0, P.h__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
...
V_74 = Vertex(name = 'V_74',
              particles = [ P.W__minus__, P.W__plus__, P.h0, P.h0 ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_79 = Vertex(name = 'V_79',
              particles = [ P.W__minus__, P.W__plus__, P.h0 ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
...
V_92 = Vertex(name = 'V_92',
              particles = [ P.Z, P.h0, P.A0 ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_80})

V_93 = Vertex(name = 'V_93',
              particles = [ P.Z, P.H, P.A0 ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
...
V_95 = Vertex(name = 'V_95',
              particles = [ P.W__minus__, P.Z, P.h0, P.h__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_98 = Vertex(name = 'V_98',
              particles = [ P.W__plus__, P.Z, P.h0, P.h__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_82})
...
V_112 = Vertex(name = 'V_112',
               ...
               couplings = {(0,1):C.GC_5,(0,0):C.GC_70})
...
V_115 = Vertex(name = 'V_115',
               ...
               couplings = {(0,1):C.GC_4,(0,0):C.GC_71})
...
V_118 = Vertex(name = 'V_118',
               ...
               couplings = {(0,1):C.GC_4,(0,0):C.GC_70})
...
V_151 = Vertex(name = 'V_151',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV5 ],
               couplings = {(0,0):C.GC_17,(0,1):C.GC_68})
...
V_154 = Vertex(name = 'V_154',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_16,(0,1):C.GC_68})
...
V_160 = Vertex(name = 'V_160',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV4 ],
               couplings = {(0,0):C.GC_16,(0,1):C.GC_69})
