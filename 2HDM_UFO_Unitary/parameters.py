...
l2 = Parameter(name = 'l2',
               nature = 'external',
               type = 'real',
               value = (1.*(Power(ca,2)*Power(mh1,2) + Power(mh2,2)*Power(sa,2) - (cb*Re(mu3))/sb))/(Power(sb,2)*Power(vev,2)),
               texname = '\\lambda _2',
               lhablock = 'Higgs',
               lhacode = [ 1 ])
...
l3 = Parameter(name = 'l3',
               nature = 'external',
               type = 'real',
               value = (2.*Power(mhc,2))/Power(vev,2) + ((-Power(mh1,2) + Power(mh2,2))*s2a)/(s2b*Power(vev,2)) - Re(mu3)/(cb*sb*Power(vev,2)),
               texname = '\\lambda _3',
               lhablock = 'Higgs',
               lhacode = [ 2 ])
...
vev2 = Parameter(name = 'vev2',
                 nature = 'internal',
                 type = 'real',
                 value = '(tanbeta*vev)/cmath.sqrt(1 + tanbeta**2)',
                 texname = '\\text{vev2}')
...
sb = Parameter(name = 'sb',
               nature = 'internal',
               type = 'real',
               value = 'tanbeta/cmath.sqrt(1 + tanbeta)',
               texname = 's_{\\beta }')

s2a = Parameter(name = 's2a',
                nature = 'internal',
                type = 'real',
                value = 'cmath.sin(2*cmath.asin(sa))',
                texname = 's_{2 \\alpha }')

s2b = Parameter(name = 's2b',
                nature = 'internal',
                type = 'real',
                value = 'cmath.sin(2*cmath.atan(tanbeta))',
                texname = 's_{2 \\beta }')
...
vev1 = Parameter(name = 'vev1',
                 nature = 'internal',
                 type = 'real',
                 value = 'cmath.sqrt(vev**2 - vev2**2)',
                 texname = '\\text{vev1}')

mu3 = Parameter(name = 'mu3',
                nature = 'internal',
                type = 'complex',
                value = 'cb*mh3**2*sb + cb*l5*sb*vev**2',
                texname = '\\text{mu3}')
...
l1 = Parameter(name = 'l1',
               nature = 'internal',
               type = 'real',
               value = '(1.*(ca**2*mh2**2 + mh1**2*sa**2 - (sb*re(mu3))/cb))/(cb**2*vev**2)',
               texname = '\\lambda _1')

l4 = Parameter(name = 'l4',
               nature = 'internal',
               type = 'real',
               value = '(1.*(mh3**2 - 2*mhc**2))/vev**2 + re(mu3)/(cb*sb*vev**2)',
               texname = '\\lambda _4')

mu1 = Parameter(name = 'mu1',
                nature = 'internal',
                type = 'real',
                value = '(-0.5*cb*vev*(cb**2*l1*vev**2 + (l3 + l4 + l5)*sb**2*vev**2) + sb*vev*re(mu3))/(cb**2*vev**2)',
                texname = '\\text{mu1}')

mu2 = Parameter(name = 'mu2',
                nature = 'internal',
                type = 'real',
                value = '(-0.5*sb*vev*(cb**2*(l3 + l4 + l5)*vev**2 + l2*sb**2*vev**2) + cb*vev*re(mu3))/(sb**2*vev**2)',
                texname = '\\text{mu2}')
